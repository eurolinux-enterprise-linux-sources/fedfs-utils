/*
 * @file src/include/xlog.h
 * @brief Syslogging functionality
 */
...
#ifndef _FEDFS_XLOG_H_
#define _FEDFS_XLOG_H_
...
/**
 * Used to define symbolic log names that can be passed to xlog_config().
 */
